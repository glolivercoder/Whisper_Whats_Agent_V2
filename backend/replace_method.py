# Script to replace the synthesize_speech method with a clean version
...
replacement_method = '''    async def synthesize_speech(self, text: str, voice: str = None, 
...
# Replace the method
lines = lines[:start_line] + [replacement_method + '\n'] + lines[end_line:]

# Write the fixed content back to the file
with open('main_enhanced.py', 'w', encoding='utf-8', newline='\n') as f:
    f.writelines(lines)

print("TTSService.synthesize_speech method replaced successfully!")