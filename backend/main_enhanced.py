        ...
        try:
            ...
            if engine == "coqui":
                if self.coqui_tts:
                    ...
                    logger.warning("Specified engine 'coqui' not available or failed, trying fallbacks...")
            
            # If we reach here, either the requested engine failed or Coqui is not available
            # Try fallback engines in order of preference
            if engine == "coqui" and not self.coqui_tts:
                logger.warning("Coqui TTS not available, trying pyttsx3 fallback...")
                engine = "pyttsx3"
            
            # Try pyttsx3 as fallback
            if engine in ["pyttsx3", "coqui"]:
                ...
                try:
                    ...
                    # Fall through to gTTS if pyttsx3 fails
