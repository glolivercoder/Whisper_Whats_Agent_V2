#!/usr/bin/env python3
"""
Teste com arquivo de voz real da pasta C:\Users\gloli\Downloads\Vozes para TTS Coqui
...
def find_voice_files():
    ...
    voice_folder = r"C:\Users\gloli\Downloads\Vozes para TTS Coqui"
    ...
    for ext in audio_extensions:
        pattern = os.path.join(voice_folder, ext)
        files = glob.glob(pattern)
        voice_files.extend(files)
